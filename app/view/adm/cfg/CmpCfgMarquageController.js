...
Ext.define('Thot.view.adm.cfg.CmpCfgMarquageController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.adm-cfg-cmpcfgmarquage',
        ...
        Ext.Ajax.request({
            ...
            callback: function (_opt, _success, oResponse) {
                ...
                if (oBack.success) {
                    ...
                    // oForm.query('#COLOS_ACTIF')[0].setValue(parseInt(oBack.liste[0].ppe_value) == 1 ? true : false);
                    // oForm.query('#MARKEMRootFolder')[0].setValue(oBack.liste[1].ppe_value);
    ...
    onApplyClick: function () {
        ...
        var oMe = this,
            ...
            oMarquageActif = oForm.query('#COLOS_ACTIF')[0],
            oRootFolder = oForm.query('#MARKEMRootFolder')[0];


        // mise à jour des options de la tache
        oMe._setAppParametre(oMarquageActif, oMarquageActif.value, '');
