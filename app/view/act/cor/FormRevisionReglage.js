 ...
 */
Ext.define("Thot.view.act.cor.FormRevisionReglage", {
    extend: "Ext.form.Panel",
    xtype: "frmrevisionreglage",
    itemId: "frmrevisionreglage",
    requires: [
        "Thot.view.act.cor.FormRevisionReglageController",
        "Thot.view.act.cor.FormRevisionReglageModel",
        'Ext.form.FieldSet',
    ...
    controller: "act-cor-formrevisionreglage",
    viewModel: {
        type: "act-cor-formrevisionreglage"
    },
    scrollable: true,
    layout: 'form',
    listeners: {
        ...
        { // opération
            ...
            items: [{ // opération
                    ...
                    autoEl: { // ajout de'un tooltip au champ de formulaire
                        tag: 'div',
                        'data-qtip': 'liste des opérations. AF = à faire, CO = commencée, TE = Terminée, '
                    }
