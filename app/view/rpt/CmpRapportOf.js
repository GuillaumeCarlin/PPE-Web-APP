Ext.define('Thot.view.rpt.CmpRapportOf', {
    extend: 'Ext.form.Panel',
    xtype: 'rapportof',
    requires: [
        'Thot.view.rpt.CmpRapportOfController',
        'Thot.view.rpt.CmpRapportOfModel'
    ],

    controller: 'rpt-cmprapportof',
    viewModel: {
        type: 'rpt-cmprapportof'
    },
        ...
        { // une grille pour afficher les opérations de l'of et leurs propriétés
            ...
            columns: [{
                ...
                },
                {
                    ...
                    text: 'Etat',
                    width: 60,
                    tooltip: 'Etat d\'avancement de l\'opération</br>AF = à faire</br>EC = en cours</br>TE = terminé</br>NR = non réalisée'
                ...
                items: [{ // Grille des activités relatives à l'opération sélectionnée 
                        ...
                        columns: [{
                            ...
                            },
                            {
                                ...
                                text: 'Opérateur',
                                flex: 1,
                                renderer: function (oGrid, oCell, oData) {
                                    sReturn = oData.data.usr_nom + ' ' + oData.data.usr_prenom;
                                    return sReturn;
                                }
                            },
                            {
