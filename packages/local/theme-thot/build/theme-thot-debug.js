...
Ext.define('Ext.theme.triton.list.TreeItem', {override:'Ext.list.TreeItem', compatibility:Ext.isIE8, updateFloated:function(floated, wasFloated) {
...
Ext.define('theme-thot.form.field.Base', {override:'Ext.form.field.Base', labelAlign:'right', labelStyle:'font-weight: 600', labelSeparator:' :', msgTarget:'side'});
...
Ext.define('theme-thot.form.field.Checkbox', {override:'Ext.form.field.Checkbox', labelAlign:'right', labelSeparator:' :', msgTarget:'side'});
...
Ext.define('Ext.theme.triton.selection.CheckboxModel', {override:'Ext.selection.CheckboxModel', headerWidth:32});
Ext.namespace('Ext.theme.is')['theme-thot'] = true;
Ext.theme.name = 'theme-thot';
