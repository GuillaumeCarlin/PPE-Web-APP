...
$aLists = [
    ...
    'sectionusers' => 'exec s_ressource.P_R_RSC_SELECT_SERVICE @RST_CODE=\'USR\', @SAB_ID=%1$s, @INACTIF=%2$s',
    'teamstatus' => 'exec s_ressource.P_R_X_USR_LIST_PRESENCE_ACTIVITE_V2 @SAB_ID_STRING=%1$s',
    'teamstatus-prod' => 'exec s_ressource.P_R_X_USR_LIST_PRESENCE_ACTIVITE @SAB_ID_STRING=%1$s',
    'sectionusersforactivity' => 'exec s_ressource.P_R_RSC_SELECT_USR_SERVICE %1$s',
    'userstatuserror' => 'exec s_ressource.P_R_X_USR_LIST_INCOHERENCE @SAB_ID_STRING=%1$s'
];
...
$aProc = [
    ...
    'setverifiercoherence' => 'EXEC s_ressource.P_IUD_USR_SetVerifierCoherence @USR_ID=%1$s, @USR_VERIFIERCOHERENCE=%2$s'
];