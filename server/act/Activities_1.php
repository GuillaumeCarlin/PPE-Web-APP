...
switch ($action) {
	...
	//dhouha le 15/10/2018


	/*var_dump($aVariables[7]);//7 ala_id   21 qterequiq
	var_dump($aVariables[21]);
	var_dump($aVariables[6]);
	var_dump($aVariables[46]);
	var_dump($aVar7iables[47]);*/
