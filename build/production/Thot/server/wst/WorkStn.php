    ...
    case 'wstnSectionAttrib':
        ...
        foreach ($aWstns as $iInd => $aWstn) {
            if ($aWstn->org_id_src > 0) {
                // DEV: 2019-03-20 22:22:38, HVT, commenté pour pouvoir affecter un équipement à plusieurs sections
                // on pourra envisager une action "transférer" qui supprime et réaffecte
                //---- On supprime la section actuellement affectée
                // $Bdd->QryExec(sprintf($aProc['sectionwstndelete'],
                //     $aWstn->rsc_id,
                //     $aWstn->org_id_src
